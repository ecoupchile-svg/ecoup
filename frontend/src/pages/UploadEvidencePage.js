...
export const UploadEvidencePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!photo) {
      toast.error('Por favor toma una foto');
      return;
    }

    if (!location) {
      toast.error('Por favor obtiene tu ubicación');
      return;
    }
    ...
    <div className="app-container">
      ...
      <div className="bg-white border-b border-gray-100 p-6">
        ...
        <p className="text-sm font-medium text-gray-500">
          Toma una foto y registra tu ubicación
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <label
                htmlFor="photo-input"
                className="w-full h-48 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 flex flex-col items-center justify-center text-gray-500 cursor-pointer hover:border-[#2BBFB3] hover:bg-[#2BBFB3]/5 transition-all"
              >
                {photoPreview ? (
                  <img
                    src={photoPreview}
                  ...
                  <>
                    ...
                    <span className="text-base font-medium">Tomar foto</span>
                  </>
                )}
              </label>
            </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <p className="text-sm text-blue-800">
              <strong>Importante:</strong> La foto y ubicación servirán como evidencia de que se realizó la recolección.
            </p>
          </div>
